...
// import { PackedUserOperation, EIP712_SAFE_OPERATION_TYPE, packGasParameters, unpackUserOperation } from './userOp'
...
//   async userOperation(paymasterAndData = '0x'): Promise<UserOperation<"v0.7">> {
